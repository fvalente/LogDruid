...
final  public class FileSaverDialog {
   ...
   * <p><b>Warning:</b> This mode is not yet implemented in the java 1.2 L&Fs.
   */
  ...
  /**
   * Returns true is the user choose the approve button of the file chooser dialog box.
   */
   ...
   * <p><b>Warning:</b> This functionnality is not yet implemented in the java 1.2 L&Fs.
   */
